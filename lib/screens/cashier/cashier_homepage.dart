          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                cartProvider.addToCart(clickedItem);
                Navigator.of(context).pop(); // Close the dialog
              },
            ),
          ],
...
// import 'package:nita_grocers/screens/admin/admin_history.dart';
// import 'package:nita_grocers/screens/admin/list_product.dart';
// import 'package:nita_grocers/screens/cashier/cashier_cart.dart';
...
//         context,
//         MaterialPageRoute(
//           builder: (context) => CashierCart(clickedItems: clickedItems),
//         ),
//       );
//     } else {
//       Navigator.push(
